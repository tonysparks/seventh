...
import seventh.client.gfx.particle_system.Emitter.ParticleRenderer;
 ...
 *
 */
public class BlendingParticleRenderer implements ParticleRenderer {

	/**
	 * 
	 */
	public BlendingParticleRenderer() {
	}
