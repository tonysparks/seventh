...
public class ClientNetworkProtocol extends NetworkProtocol implements ClientProtocol {
    ...
    protected void processMessage(Connection conn, NetMessage message) throws IOException {
        ...
        if(message instanceof GameUpdateMessage) {
            ...
            receiveGameEventMessage(conn, (GameEventMessage)message);
        }
        /* None game messages */
    ...
    /* (non-Javadoc)
     * @see seventh.client.network.ClientProtocol#receiveSurvivorEventMessage(harenet.api.Connection, seventh.network.messages.GameEventMessage)
     */
    @Override
    public void receiveGameEventMessage(Connection conn, GameEventMessage msg) {
        if(game!=null) {
            game.gameEventMessage(msg);
        }        
    }
    ...
    /* (non-Javadoc)
     * @see seventh.client.network.ClientProtocol#sendPlayerSwitchTileMessage(seventh.network.messages.PlayerSwitchTileMessage)
     */
    @Override
